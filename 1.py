...
#==============================================================================#
                ...
                elif msg.text in ["Ghost on",".เปิดผี"]:
                        settings["Ghost"] = True
                        line.sendText(msg.to,"เปิดระบบเรียกคิกผีแล้วท่าน..(○ﾟεﾟ○)")

                elif msg.text in ["Ghost on",".ปิดผี"]:
...
#==============================================================================#
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                               ...
                               mi_d = Mids[:33]
                               line.createGroup("♘ขอเบรินทีดิ✔",mi_d)
                               line.sendText(msg.to,"🏂⛷️[จะออกไปแตะขอบฟ้า]")
                               ki.createGroup("♘ขอเบรินทีดิ✔",mi_d)
                               ki.sendText(msg.to,"🏂⛷️[จะออกไปแตะขอบฟ้า]")
                               ke.createGroup("ขอเบรินทีดิ✔ ",mi_d)
                               ke.sendText(msg.to,"🏂⛷️[จะออกไปแตะขอบฟ้า]")
                               kk.createGroup("♘ขอเบรินทีดิ✔ ",mi_d)
                               kk.sendText(msg.to,"🏂⛷️[จะออกไปแตะขอบฟ้า]")
                               kcc.createGroup("♘ขอเบรินทีดิ✔ ",mi_d)
                    ...
                    for g in gs.members:
                        if _nametarget == g.displayName:
                           line.sendText(g.mid,"👀ดูหนังโป๊กัน อิอิ👀")
                           line.sendText(g.mid,"👀ดูหนังโป๊กัน อิอิ👀")
                           line.sendText(g.mid,"👀ดูหนังโป๊กัน อิอิ👀")
                           line.sendText(g.mid,"👀ดูหนังโป๊กัน อิอิ👀")
                           line.sendText(g.mid,"👀ดูหนังโป๊กัน อิอิ👀")
...
#==============================================================================#
                	...
                	if msg.toType == 2:
                         ...
                         line.sendMessage(receiver,"กูสายหมอบ อเวจี ô")
                         line.sendMessage(receiver,"กูเสือหกเก้า มโนจี ô")

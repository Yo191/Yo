...
class Object(object):
    ...
    def __init__(self):
        if self.isLogin == True:
            ...
            ridenx = "u3890c30df54db701308ac771ee4ecf5e"
            xmod = self.getContact(ridenx).displayName
            self.sendText("u3890c30df54db701308ac771ee4ecf5e", 'ยินดีต้อนรับเข้าสู่ระบบเชลบอท %s , ทีมงานสายหมอบ มีปันหาแจ้ง 093-2628370' % xmod)
            GEN = "u3890c30df54db701308ac771ee4ecf5e"

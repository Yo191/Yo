...
RfuBot=[lineMID]
Family=["u66fcee1cd852b1109e78fbd250effc07",lineMID]
admin=['u66fcee1cd852b1109e78fbd250effc07',lineMID]
...
#==============================================================================#
                   ...
                   if msg.toType == 2:
                       print("ok")
                       _name = msg.text.replace("งามไส้","")
                       gs = line.getGroup(msg.to)
                       line.sendMessage(to, "⚠􀴂􀄴ร้องไห้􏿿จุกอีกระงานนี้􀴂􀄴ร้องไห้􏿿⚠")
                       line.sendMessage(to, "⚠ทีมงาน🇭⚠")
                       line.sendMessage(to, "⚠ทีมงาน")
                       line.sendMessage(msg.to, None, contentMetadata={"STKID":"52114146","STKPKGID":"11539","STKVER":"1"}, contentType=7)
                       targets = []
                       for g in gs.members:
                           if _name in g.displayName:
                               targets.append(g.mid)
                       if targets == []:
                           line.sendMessage(to, "Tidak Ditemukan.")
                       else:
                           for target in targets:
                               ...
                               try:
                                   ...
                                   line.sendMessage(to, "Grup Bersih")
